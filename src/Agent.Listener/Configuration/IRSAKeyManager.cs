...
namespace Microsoft.VisualStudio.Services.Agent.Listener.Configuration
{
    ...
    {
        public static async Task<(bool useNamedContainer, bool useCng)> GetStoreAgentTokenInNamedContainerFF(this IRSAKeyManager rsaKeyManager, IHostContext hostContext, global::Agent.Sdk.ITraceWriter trace, AgentSettings agentSettings, VssCredentials creds, CancellationToken cancellationToken = default)
        {
    ...
    internal class RSAParametersSerializable : ISerializable
    {
        ...
        public RSAParametersSerializable(SerializationInfo information, StreamingContext context)
        {
            ...
            _useCng = (bool)information.GetValue("UseCng", typeof(bool));
